#!/usr/bin/env bash
# ============================================================
# 星耀途道层零漂移守护脚本 v5.1 (learning-coaching-toolkit 适配版)
# Compliance: v5.1 | grep 6 漂移=0 命中 | 2026-05-20
# ============================================================
# 用途:CI 道层合规验证,grep 6 类 v4.1 漂移关键词,任一命中 exit 1
...
echo -e "${YLW}  仓库: learning-coaching-toolkit${NC}"
