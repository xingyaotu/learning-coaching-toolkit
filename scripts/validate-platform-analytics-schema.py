...
验证项:
  1. JSON 文件加载
  2. platform_analytics_schema: stage_distribution_platform 七阶 + _dao_guard
...
def main() -> None:
    ...
    # [2] stage_distribution_platform 七阶 + _dao_guard
    ...
    # [4] bottleneck_distribution_platform MECE + _dao_guard
    print("\n[4] bottleneck_distribution_platform MECE 四维度 + _dao_guard")
    ...
    # [6] sop05_compliance_rate_platform ⑤守护
    print("\n[6] sop05_compliance_rate_platform ⑤守护 含'流程'")
    ...
    # [10] minimum_cell_size_rule min=50 + PIPL _dao_guard
    print("\n[10] minimum_cell_size_rule min=50 + _dao_guard 含'PIPL'")
