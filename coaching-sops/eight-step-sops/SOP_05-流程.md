---
name: SOP_05-流程
description: 八步学习法第5步:解题流程 SOP — 标准化执行解题步骤(★第5步=流程,名称固定不可更改)
version: "1.0"
eight_step_id: 5
eight_step_name: 流程
...
## ★ 关键提醒
**第5步的名称是"流程",此为核心道层约定,不可更改。**
任何文档/代码/提示词中若误写第5步名称,均属道层漂移错误,须立即修正。
...
interface ProcessSession {
  ...
  ★_critical_note: "第5步唯一合法名称为流程";
}
```

## 道层合规说明
- 八步第⑤步 = **流程** | 全称: ①穿透 ②提取 ③整理 ④审题 **⑤流程** ⑥批改 ⑦分析 ⑧估分
- 六飞轮 = 计划飞轮/预习飞轮/复习飞轮/听课飞轮/作业飞轮/考试飞轮(六个名称固定不变)
